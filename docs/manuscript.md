...
full FIRED population and a first final-centroid gridMET projection. The
[corrected v2 analysis](reanalysis-v2.md) is the repository authority for
quantitative claims. It uses consecutively observed histories, a shape-only
coordinate system, exact calendar-day transitions, day-specific exposure, and
explicit null and stability tests. Its results narrow—but preserve—the central
